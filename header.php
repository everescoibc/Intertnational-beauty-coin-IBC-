<menu id="menu">
	<div id="menu-ta-pc">
		<center>
			...
			<div class="menu-row">
				<a href="#section05"><span><h1>EVERESCO介绍</h1></span></a>
				<a href="#section03"><span><h1>IBC介绍</h1></span></a>
				<a href="../dashboard/cn/main.php" target="_blank"><span><h1>仪表板</h1></span></a>
				<a href="#"><span><h1>论坛</h1></span></a>
				<a href="#"><span><h1>客服中心</h1></span></a>
				<span>
	...
	<div id="menu-mo">
		...
		<div id="panel">
			<a href="#section05"><div class="mo"><h1>EVERESCO介绍</h1></div></a>
			<a href="#section03"><div class="mo"><h1>IBC介绍</h1></div></a>
			<a href="../dashboard/cn/main.php" target="_blank"><div class="mo"><h1>仪表板</h1></div></a>
			<a href="#"><div class="mo"><h1>论坛</h1></div></a>
			<a href="#"><div class="mo"><h1>客服中心</h1></div></a>
			<div class="mo">
				<select onchange="window.open(value,'_top');">
					<option value="https://everesco.org/cn">中国</option>
					<option value="https://everesco.org/en">English</option>
